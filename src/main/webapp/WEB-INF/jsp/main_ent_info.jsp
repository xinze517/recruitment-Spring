...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
    ...
    <a class="btn btn-outline-primary" href="${pageContext.request.contextPath}/ent/mainPage?tab=info">返回主页</a>
</div>

<div class="container my-5">
    <form action="${pageContext.request.contextPath}/ent/editInfo" method="post">
        <label class="sr-only">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="legal_representative" id="legal_representative" class="form-control"
                           value="${entInfo.legal_representative}" required="required"/>
                </div>
                <div class="col-md-6 mb-3">
                    <label for="established_date">成立时间</label>
                    <input type="date" name="established_date" id="established_date" class="form-control"
                           value="<fmt:formatDate value="${entInfo.established_date}" pattern="yyyy-MM-dd"/>"
                           required="required"/>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="email" name="email" id="email" class="form-control"
                           value="${entInfo.email}" required="required"/>
                </div>
                <div class="col-md-6 mb-3">
                    <label for="name">公司全称</label>
                    <input type="text" name="name" id="name" class="form-control" value="${entInfo.name}"
                           required="required"/>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="home_page" id="home_page" class="form-control"
                           value="${entInfo.home_page}" required="required"/>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <textarea class="form-control" name="introduction" id="introduction" rows="5"
                              required="required">${entInfo.introduction}</textarea>
                </div>
            </div>
            <hr class="md-4">
            <div class="row">
